...
<template>
    <div id="bootPage">
					...
					<div class="portlet-body">
						...
						<div class="table-scrollable">
							<el-table :data="tableData" >
							    ...
							    <el-table-column prop="paramOne" label="跳过时间(s)"></el-table-column>
							</el-table>
    	...
    	<el-dialog  :title="dialogTitle" :visible.sync="dialogVisible" width="30%" @close="handleCancle">
    		...
    		<div class="dialog-item">
    			<span>跳过时间：</span>	
    			<input type="text" class="form-control input-inline" placeholder="请输入跳过时间" v-model="dialogObj.paramOne">	
    		</div>
...
export default {
    name: 'bootPage', // App开机页配置 
    data() {
        return {
        	breadcrumbs: { first: 'APP管理', second: 'App开机页配置' },
            tableData: [],
            total: 0,
            pageNum: 1,
    ...
    methods: {
    	...
    	_getData() {
    		var that = this,
				...
				params = { configType: 1 }; //1.App开机页配置2.首页活动图层配置3.每日签到配置4.菜单配置,不传是查询所有
    	...
    	handleAc() {
    		...
    		this.dialogObj.paramOne = this.tableData[0].paramOne;
    	...
    	handleSave() {
            var _that = this,
	            ...
	            formData.append("appList[0].paramOne", this.dialogObj.paramOne);
