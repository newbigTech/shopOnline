...
Vue.prototype.onGood = {
    ...
    adminHeader: '/static/img/header.png',
    adInfo: '购物，想象不到的惊喜！',
    onUnit: '积分',
    details: '校园购物 - 宅寄送, 准时, 准点, 送货上门. 支持线上下单,线下支付. ',
};

Vue.prototype.token = 'be5bdbbd24864840acd07feb1b2805a3';
Vue.prototype.userInfo = {"birthday":1606752000000,"country":null,"notes":null,"weiboName":null,"gender":2,"loginType":"","city":null,"idCard":null,"customerCode":"6ebfe21938d447c498585736b12faac1","couponId":null,"type":1,"trueName":null,"phoneUrl":"http://test.img.mall.yipingoo.com/resources//my/photo/20180403/cd0e305b-f76b-4faf-a37e-39863723b78b.jpg","loginTime":null,"qrCode":"http://img.mall.yipingoo.com/register?phone=18075177451","couponType":null,"receiveImg":null,"customerId":10000072,"contactNumber":"18075177451","customerInfoId":65,"state":"A","wxName":null,"email":"blood@qq.com","outLoginTime":null,"address":null,"pointAmount":25895,"nickName":"树上五只猴","postcode":null,"wxId":null,"qqId":null,"isExtend":"0","phone":"18075177451","weiboId":null,"qqName":null,"region":null,"isExitPwd":"1","payPassword":true,"token":"be5bdbbd24864840acd07feb1b2805a3"};
Vue.prototype.baseUrl = 'http://wechat2.yipingoo.com';
Vue.prototype.onlineUrl = 'http://wechat.yipingoo.com'; //v2.0
...
Vue.prototype.uploadImgFn = function(Dom) {
    ...
    if (fileType != 'image/png' && fileType != 'image/jpeg' && fileType != 'image/gif') {
        this.$message('图片格式只能是jpg、png或者gif');
        Dom.innerText = '';
        Dom.value = '';
        return false;
    }
    return { fileObj: fileObj, fileUrl: URL.createObjectURL(fileObj) };
}
...
Vue.prototype.isIosOrAndroid = function() {
    if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) { return 'IOS' } else if (/(Android)/i.test(navigator.userAgent)) { return 'Android' }
}

// 金额格式化
Vue.prototype.onlyMoney = function(money) {
    //先把非数字的都替换掉，除了数字和.     
